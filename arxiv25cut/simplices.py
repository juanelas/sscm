...
from arxiv25cut.arxiv_classes.arxiv import Author, Paper
from arxiv25cut.arxiv_db import arxiv_db
            ...
            with open(os.path.join(basedir, filename), 'rb') as file:
                ...
                for record in records['record']:
                    if 'metadata' in record:
                        ...
                        bounded_authors = 25 if len(
                            record_authors) > 25 else len(record_authors)
