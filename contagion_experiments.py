...
simulations_parameters = [
    ...
    #     "independent_noises": False
    # },
    # {  # Experiment 3 paper no stochastic
    #     "tag": "ex3_sigma0",
    #     "mu": 0.5,
    #     "betas": np.array([.0375]),
    #     "rho0s_per_beta_delta": {
	...
	# }
	{
		"tag": "THHV23_InVS15_ex1a",
		"mu": 0.7,
		"betas": np.array([0.014]),
		"rho0s_per_beta_delta": {
			0.019: [0.2, 0.8]
		},
		"timesteps": 1000,
		...
		"sigma_delta": 0.0094,
		"bounded_delta": False,
		"independent_noises": True
	},
	{
		"tag": "THHV23_InVS15_ex1a_sigma0",
		"mu": 0.7,
		"betas": np.array([0.014]),
		"rho0s_per_beta_delta": {
			0.019: [0.2, 0.8]
	...
	{
		"tag": "THHV23_InVS15_ex2",
		"mu": 0.6,
		"betas": np.array([0.0319]),
		"rho0s_per_beta_delta": {
			0.0087: [0.2, 0.8]
		},
		"timesteps": 1000,
	...
	{
		"tag": "THHV23_InVS15_ex3",
		"mu": 0.5,
		"betas": np.array([0.375]),
		"rho0s_per_beta_delta": {
			0.0578: [0.2, 0.8]
		},
		"timesteps": 1000,
	...
	{
		"tag": "THHV23_N500_k20.348_kdelta6.084_ex1a",
		"mu": 0.7,
		"betas": np.array([0.025]),
		"rho0s_per_beta_delta": {
			0.0417: [0.2, 0.8]
	...
	{
		"tag": "THHV23_N500_k20.348_kdelta6.084_ex1a_sigma0",
		"mu": 0.7,
		"betas": np.array([0.025]),
		"rho0s_per_beta_delta": {
			0.0417: [0.2, 0.8]
	...
	{
		"tag": "THHV23_N500_k20.348_kdelta6.084_ex1b",
		"mu": 0.7,
		"betas": np.array([0.014]),
		"rho0s_per_beta_delta": {
			0.01: [0.2, 0.8]
	...
	{
		"tag": "THHV23_N500_k20.348_kdelta6.084_ex1b_sigma0",
		"mu": 0.7,
		"betas": np.array([0.014]),
		"rho0s_per_beta_delta": {
			0.01: [0.2, 0.8]
	...
	{
		"tag": "THHV23_N500_k20.348_kdelta6.084_ex2",
		"mu": 0.5,
		"betas": np.array([0.035]),
		"rho0s_per_beta_delta": {
			0.02: [0.2, 0.8]
		},
		"timesteps": 2000,
	...
	{
		"tag": "THHV23_N500_k20.348_kdelta6.084_ex2_sigma0",
		"mu": 0.5,
		"betas": np.array([0.035]),
		"rho0s_per_beta_delta": {
			0.02: [0.2, 0.8]
	...
	{
		"tag": "THHV23_N500_k20.348_kdelta6.084_ex3",
		"mu": 0.5,
		"betas": np.array([0.04]),
		"rho0s_per_beta_delta": {
			0.08: [0.2, 0.8]
	...
	{
		"tag": "THHV23_N500_k20.348_kdelta6.084_ex3_sigma0",
		"mu": 0.5,
		"betas": np.array([0.04]),
		"rho0s_per_beta_delta": {
			0.08: [0.2, 0.8]
